...
/**
 *
 * @author Isaac Griffith (And a few at the end, by Brandon Watkins)
 */
public class LinkedBinaryTreeTest {
    ...
    @Test
    public void testSubTreeSize_1(){
        BinaryTreeNode root = fixture.createNode(0, null, null, null);
        fixture.root = root;
        assertEquals(1, fixture.subTreeSize(root));
    }

    @Test
    public void testSubTreeSize_2(){
        BinaryTreeNode root = fixture.createNode(0, null, null, null);
        fixture.setRoot(root);
        assertEquals(1, fixture.subTreeSize(fixture.root()));
        assertEquals(root, fixture.root());
    }

    @Test
    public void testSubTreeSize_3(){
        LinkedBinaryTree<String> fixture2 = new LinkedBinaryTree<String>();
        BinaryTreeNode root = fixture2.createNode("root", null, null, null);
        fixture2.setRoot(root);
        BinaryTreeNode p = (BinaryTreeNode)fixture2.root();

        for (int i = 0; i < 3; i++){
            fixture2.addLeft(p, fixture2.createNode(("(" + p.getElement() + "'s left child. i = " + i + ")"), p, null, null));
            fixture2.addRight(p, "(" + p.getElement() + "'s right child. i = " + i + ")");
            p = fixture2.left(p);
        }

        assertEquals(fixture2.size(), 7);
        assertEquals(fixture2.size(), fixture2.subTreeSize(fixture2.root()));
        assertEquals(1, fixture2.subTreeSize(p));
        assertEquals(3, fixture2.subTreeSize(p.getParent()));
        assertEquals(1, fixture2.subTreeSize(p.getParent().getRight()));

        fixture2.setRoot(null);
        assert(fixture2.root() == null);

        fixture2.setRoot(0);
        assertEquals(1, fixture2.size());
        assertEquals(1, fixture2.subTreeSize(fixture2.root()));
    }
    ...
    public void testIsLastChild(){
        ...
        assertTrue(fixture2.isLastChild(root));

        BinaryTreeNode left1 = fixture2.addLeft(root, fixture2.createNode(("(root's left child)"), root, null, null));
        BinaryTreeNode right1 = fixture2.addRight(root, "(root's right child)");
        assertFalse(fixture2.isLastChild(left1));
        assertTrue(fixture2.isLastChild(right1));

        BinaryTreeNode left2 = fixture2.addLeft(left1, fixture2.createNode(("(root:left's left child)"), left1, null, null));
        BinaryTreeNode left3 = fixture2.addLeft(left2, "(root:left:left's left child)");
        BinaryTreeNode right2 = fixture2.addRight(left3, "(root:left:left:left's right child)");
        assertTrue(fixture2.isLastChild(left2));
        assertTrue(fixture2.isLastChild(left3));
        assertTrue(fixture2.isLastChild(right2));
    }
